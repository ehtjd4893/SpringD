...
-- 이미지파일은 추후 수정
INSERT INTO ROOM VALUES(ROOM_SEQ.NEXTVAL, '스위트 킹베드', 290000, 5, 'resources/name1.PNG', 8, 5);
INSERT INTO ROOM VALUES(ROOM_SEQ.NEXTVAL, '스위트 트윈베드', 330000, 5, 'resources/name2.PNG', 8, 5);
INSERT INTO ROOM VALUES(ROOM_SEQ.NEXTVAL, '스위트 럭셔리 킹베드', 350000, 5, 'resources/name3.PNG', 8, 5);
INSERT INTO ROOM VALUES(ROOM_SEQ.NEXTVAL, '스위트 클럽룸', 300000, 5, 'resources/name4.PNG', 8, 5);
INSERT INTO ROOM VALUES(ROOM_SEQ.NEXTVAL, '스위트 클럽 트윈', 320000, 5, 'resources/name5.PNG', 8, 5);
